    ...
    constructor() {
        ...
        this.register = (req, res) => {
            ...
            const schema = joi_1.default.object({
                ...
                birthday: joi_1.default.date().iso().required(),
                phone: joi_1.default.string().min(6).max(15).required(),
