...
export class UserController {
                    ...
                    pool.query(sql, [username, firstname, lastname, hashedPassword, null, phone, location, type, email, backPhoto, "data:image/png;base64,"],
                        (err, result) => {
                            ...
                            transporter.sendMail(mailOptions, function (err, info) {
                                if (err) return databaseFatalError(res, err, 'register failed: email error');
    ...
    getUserProfessionsById = (req: express.Request, res: express.Response) => {
        /**
         * @param {number} id - id of the user
        ...
        pool.query(sql, [id], (err, professions) => {
            if (err) return databaseFatalError(res, err, 'getUserProfessionsById failed');
    ...
    addComment = (req: express.Request, res: express.Response) => {
        ...
        const idUserReq = (req as any).userId; // jwt token
        if (idCommentator != idUserReq) return databaseFatalError(res, null, 'addComment failed: Unauthorized');
    ...
    getCommentById = (req: express.Request, res: express.Response) => {
        ...
        const idUserReq = (req as any).userId; // jwt token
        if (idUser != idUserReq) return databaseFatalError(res, null, 'getCommentById failed: Unauthorized');
    ...
    deleteCommentById = (req: express.Request, res: express.Response) => {
         ...
         */
        const { id } = req.body;
        const userId = (req as any).userId; // jwt token
    ...
    rate = (req: express.Request, res: express.Response) => {
        ...
        if (!idUser || !idRater || rate === undefined) return databaseFatalError(res, null, 'rate failed: Missing required fields');

        if (idUser === idRater) return databaseFatalError(res, null, 'rate failed: User cannot rate himself');

        if (idRater != idUserReq) return databaseFatalError(res, null, 'rate failed: Unauthorized');

        if (typeof rate !== "number" || rate < 1 || rate > 5) return databaseFatalError(res, null, 'rate failed: Invalid rate value');
    ...
    getRateByIdUser = (req: express.Request, res: express.Response) => {
        ...
        const { idUser } = req.body;
        const idUserReq = (req as any).userId; // jwt token
        if (idUser != idUserReq) return databaseFatalError(res, null, 'getRateByIdUser failed: Unauthorized');
    ...
    getRateByIdUserAndRater = (req: express.Request, res: express.Response) => {
        ...
        const idUserReq = (req as any).userId; // jwt token
        if (idUser != idUserReq && idRater != idUserReq) return databaseFatalError(res, null, 'getRateByIdUserAndRater failed: Unauthorized');
    ...
    changePassword = (req: express.Request, res: express.Response) => {
        ...
        const idUserReq = (req as any).userId; // jwt token
        if (idUser != idUserReq) return databaseFatalError(res, null, 'changePassword failed: Unauthorized');
    ...
    updateUser = (req: express.Request, res: express.Response) => {
        ...
        const idUserReq = (req as any).userId;
        if (idUser != idUserReq) return databaseFatalError(res, null, 'updateUser failed: Unauthorized');
        ...
        pool.query(sql, [username, email, firstname, lastname, birthday, location, phone, photo, backPhoto, distance, info, idUser], (err, message) => {
            if (err) return databaseFatalError(res, err, 'updateUser failed');
            logger.info({ idUser }, 'User updated');
            return res.json({ error: 0, message: message });
        });
    ...
    isUserSubscribed = (req: express.Request, res: express.Response) => {
        /**
         * @param {number} userId - id of the user
         * @returns {json} - subscribed or not
         */
        const idUserReq = (req as any).userId;
        if (!idUserReq) return databaseFatalError(res, null, 'isUserSubscribed failed: Unauthorized');

        const sql = 'SELECT * FROM subscriptions WHERE user_id = ?';
        pool.query(sql, [idUserReq], (err, results) => {
            if (err) return databaseFatalError(res, err, 'isUserSubscribed failed');
            if (results.length) {
    ...
    getTop3Masters = (req: express.Request, res: express.Response) => {
        /**
