...
export class UserController {
    ...
    register = (req: express.Request, res: express.Response) => {
        const { username, firstname, lastname, password, birthday, phone, location, role, email } = req.body;
    ...
    changePassword = (req: express.Request, res: express.Response) => {
        ...
        connection.query(sql, [newPassword, idUser, password], (err, comments) => {
    ...
    updateGallery = (req: express.Request, res: express.Response) => {
        ...
        connection.query(sql, [idUser], (err, comments) => {
            ...
            images.forEach(element => {
                ...
                connection.query(sql1, [idUser, element], (err, comments) => {
                    if (err) { res.json({ error: 1, message: "Fatal error: " + err }); console.log('updateGallery failed'); return; }
                });
            });
        });
    ...
    getIdByEmail = (req: express.Request, res: express.Response) => {
        ...
        connection.query(sql, [email], (err, id) => {
    ...
    updateUser = (req: express.Request, res: express.Response) => {
        ...
        connection.query(sql, [username, email, firstname, lastname, birthday, location, phone, photo, idUser], (err, id) => {
    ...
    forgotPasswordRequest = (req: express.Request, res: express.Response) => {
        ...
        connection.query(query, [reset_token.token, req.body.email, expire_time], (err, result) => {
            if (err) {
                console.error('Error inserting token into the database:', err);
                res.status(400).json({ 'message': 'error' });
                return;
            }
            else console.log("Token saved in database");
        });
    ...
    tokenValidation = (req: express.Request, res: express.Response) => {
        ...
        connection.query(query, [token], (err, results) => {
            ...
            if (results.length > 0) {
                ...
                if (new Date() > foundToken.expire_time) res.status(200).json({ 'poruka': 'Vreme isteklo' });
                else { console.log('Token dobar'); res.status(200).json({ 'poruka': 'Ok', 'email': foundToken.email }); }
            } else {
    ...
    changeForgottenPassword = (req: express.Request, res: express.Response) => {
        ...
        connection.query(searchQuery, [email], (err, results) => {
            ...
            if (results.length > 0) {
                ...
                connection.query(updateQuery, [password, email], (err, updateResult) => {
                    if (err) {
